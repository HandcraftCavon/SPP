...
def main():
	while True:
		...
		rotation_x, rotation_y, rotation_z = MOTION.get_rotation()
		...
		print ''
		print 'X gyro_x :', gyro_x, ' scaled :', scaled_gyro_x
		print 'Y gyro_y :', gyro_y, ' scaled :', scaled_gyro_y
		print 'Z gyro_z :', gyro_z, ' scaled :', scaled_gyro_z
		print ''
